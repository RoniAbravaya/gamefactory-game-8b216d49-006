...
class GameColors {
  ...
  static const Color primary = Color(0xFFFFF5EE);
  static const Color secondary = Color(0xFF87CEEB);
  static const Color accent = Color(0xFFFFD700);
  static const Color success = Color(0xFFFF69B4);
  static const Color warning = Color(0xFF008000);
